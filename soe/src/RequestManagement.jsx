...
function RequestManagement() {
  ...
  const filteredRequests = requests.filter(request => {
    ...
    const matchesSearch = 
      ...
      request.natureOfWork.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    <div className="app-container">
      <div className="request-management-container">
        ...
        <div className="tabs-container">
          <div className="tabs">
            <button 
              className={`tab ${activeTab === 'All' ? 'active' : ''} tab-first`}
            ...
            <button 
              className={`tab ${activeTab === 'Completed' ? 'active' : ''} tab-last`}
        ...
        <div className="content-container">
          {showRequests ? (
                  ...
                  <table className="request-table">
                    <thead>
                      <tr className="table-header">
                        <th className="table-cell checkbox-cell"></th>
                        <th className="table-cell">Type</th>
                        <th className="table-cell">Reference No.</th>
                        <th className="table-cell">From</th>
                        <th className="table-cell">Date Submitted</th>
                        <th className="table-cell">Date Needed</th>
                                            ...
                                            <tr key={index}>
                                              <td className="particulars-cell">
                                                <input 
                                                  ...
                                                  className="qty-input"
                                                  value={item.qty}
                                                  onChange={(e) => handleParticularsChange(index, 'qty', e.target.value)}
                                                />
                                              </td>
                                              <td className="particulars-cell">
                                                <input 
                                                  ...
                                                  value={item.details}
                                                  onChange={(e) => handleParticularsChange(index, 'details', e.target.value)}
                                                />
                                              </td>
                                            </tr>
                                          ))}
            ...
            <div className="new-request-form">
              ...
              <div className="reference-number">{selectedRequest?.referenceNo}</div>
                ...
                <div className="form-left">
                  <div className="form-group">
                    ...
                    <input 
                      ...
                      onChange={(e) => setSelectedRequest({...selectedRequest, from: e.target.value})}
                    />
                  </div>
                  <div className="form-group">
                    <div className="form-label">Date Submitted:</div>
                    <div className="form-value">{selectedRequest?.dateSubmitted}</div>
                  </div>
                  <div className="form-group">
                    <div className="form-label">Date Needed:</div>
                    <input 
                      ...
                      value={selectedRequest?.dateNeeded || ''}
                      onChange={(e) => setSelectedRequest({...selectedRequest, dateNeeded: e.target.value})}
                    />
                  </div>
                  <div className="form-group">
                    <div className="form-label">Nature of Work:</div>
                    <input 
                      type="text" 
                      className="text-input"
                      value={selectedRequest?.natureOfWork || ''}
                      onChange={(e) => setSelectedRequest({...selectedRequest, natureOfWork: e.target.value})}
                    />
                  </div>
                </div>
                <div className="form-right">
                  <table className="particulars-table">
                    ...
                    <tbody>
                      {selectedRequest?.particulars.map((item, index) => (
                        <tr key={index}>
                          <td className="particulars-cell">
                            <input 
                              type="text" 
