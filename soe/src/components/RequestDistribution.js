      ...
      <div className="pie-chart">
        <svg viewBox="0 0 100 100">
          ...
          {data.map((item, index) => {
            ...
            const startX = 50 + 25 * Math.cos((startAngle - 90) * Math.PI / 180);
            const startY = 50 + 25 * Math.sin((startAngle - 90) * Math.PI / 180);
            const endX = 50 + 25 * Math.cos((currentAngle - 90) * Math.PI / 180);
            const endY = 50 + 25 * Math.sin((currentAngle - 90) * Math.PI / 180);
