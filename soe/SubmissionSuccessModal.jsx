...
/**
 * A modal that displays a success message with a reference code.
 *
 * @param {object} props - The component props.
 * @param {boolean} props.isOpen - Whether the modal should be visible.
 * @param {function} props.onClose - Function to call when the modal is closed.
 * @param {string} props.referenceCode - The reference code to display.
 * @returns {JSX.Element|null} The rendered component or null.
 */
const SubmissionSuccessModal = ({ isOpen, onClose, referenceCode }) => {
  if (!isOpen) {
    return null;
  }
  ...
  return (
    <div style={successModalOverlayStyle} onClick={onClose}>
      <div style={successModalContainerStyle} onClick={(e) => e.stopPropagation()}>
