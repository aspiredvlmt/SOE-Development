...
const LoginForm = () => {
    ...
    const handleSubmit = () => {
        ...
        // Create user info object with the selected role
        const userInfo = {
            username: username,
            role: role,
        ...
        // Create a mock login ID and token (you can replace this with actual login logic)
        const loginID = Date.now(); // Simple ID generation
        const mockToken = 'mock-jwt-token-' + Date.now(); // Mock token for demo

        console.log('Calling login with:', userInfo, loginID);

        // Call the login function from context
        login(userInfo, loginID);
        
        // Set the token to make isAuthenticated() return true
        setToken(mockToken);
